          ...
          <div className="grid lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3">
              <Card className="shadow-lg">
                ...
                <h2 className="text-xl  text-gray-900 leading-relaxed font-semibold">
    {question.question.split('\n').map((line, index) => (
      <span key={index}
      className={index===0?'font-semibold':'font-normal text-lg'}
              ...
              <div key={question.id} className="p-5 hover:bg-gray-50 transition-colors duration-200 rounded-2xl">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-800 mb-4 font-medium text-base sm:text-lg">{question.question.split('\n').map((line, index) => (
        <span key={index}>
          {line}
          {index < question.question.split('\n').length - 1 && <br />}
        </span>
